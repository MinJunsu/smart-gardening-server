...
SECRET_KEY = ')7j0pe$h&ee^-_3o0a5&7s@yquzu^--ajd^(4_30dvucrca9xt'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', "www.smart-gardening.kro.kr", "138.91.37.37", "cashup.iptime.org"]
...
DATABASES = {
    'default': {
        ...
        'USER': 'sunsuking',
        'PASSWORD': 'junsu123!',
        'HOST': 'sunsuking.postgres.database.azure.com',
        'PORT': '5432',
    }
}
